            ...
            <div class="mt-8 lg:mt-0 overflow-hidden">
                <div class="grid grid-cols-1 md:grid-cols-2 place-items-center">
                    <div class="p-6 lg:p-12 bg-gray-900 rounded-lg text-center lg:text-left w-4/5 lg:w-auto mb-5 lg:mb-0">
                        <h1 class="text-2xl sm:text-4xl text-white font-extrabold tracking-tight uppercase">
                            Get in touch
                        </h1>
                    ...
                    <form class="flex flex-col justify-center w-3/4">
                        ...
                        <div class="flex flex-col mt-2">
                            ...
                            <input type="tel" name="tel" id="tel" placeholder="Contact Number" class="w-100 mt-2 py-3 px-3 rounded-lg bg-white dark:bg-gray-800 border border-gray-400 dark:border-gray-700 text-gray-100 font-semibold focus:border-indigo-500 focus:outline-none"/>
                        </div>
